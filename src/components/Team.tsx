  ...
  <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
          ...
          <p className="text-gray-600 mb-4">Professor of Medicine & Gastroenterology Department</p>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
          ...
          <p className="text-blue-600 font-semibold mb-4">Consultant Physician & Gastroenterologist</p>
